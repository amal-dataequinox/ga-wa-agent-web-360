...
function LeftSidebarMenu(props: any) {
...
console.log("name :", firstName,lastName);
    ...
    return (
        <React.Fragment>
            <div className="side-menu flex-lg-column me-lg-1 fixed">
                {/* LOGO */}
                ...
                <div className="flex-lg-column my-auto">
                    <Nav pills className="side-menu-nav justify-content-center" role="tablist">
                        <NavItem id="home">
                            <NavLink id="pills-user-tab" className={classnames({ active: activeTab === 'home' })} onClick={() => { toggleTab('home'); }}>
                        ...
                        <NavItem id="broadcast">
                            <NavLink id="pills-broadcast-tab" className={classnames({ active: activeTab === 'broadcast' })} onClick={() => { toggleTab('broadcast'); }}>
                    ...
                    <Nav className="side-menu-nav justify-content-center">
                        ...
                        <Dropdown nav isOpen={dropdownOpen} className="nav-item btn-group dropup profile-user-dropdown" toggle={toggle}>
                            <DropdownToggle className="nav-link " tag="a">
                                ...
                                <h5 className="rounded-circle-profile  "> {firstName?.slice(0, 1).toUpperCase()}{lastName?.slice(0, 1).toUpperCase()} </h5>
                            </DropdownToggle>
                            <DropdownMenu>
                                <DropdownItem onClick={() => { toggleTab('profile'); }}>Profile <i className="ri-profile-line float-end text-muted"></i></DropdownItem>
                                <DropdownItem onClick={() => { toggleTab('settings'); }}>Setting <i className="ri-settings-3-line float-end text-muted"></i></DropdownItem>
