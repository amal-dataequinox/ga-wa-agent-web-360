...
export default class URLConstants {
    ...
    static CREATE_WB_ACCOUNT_BASE_URL: string = URLConstants.GAUS_BASE_URL + "/whatsapp-business/accounts";
    ...
    static GET_TEMPLATES_BASE_URL: string = URLConstants.GAUS_BASE_URL + "/whatsapp/templates";
    static GET_WB_ACCOUNT_BASE_URL: string = URLConstants.GAUS_BASE_URL + "/whatsapp-business/accounts";
    ...
    static CHAT_LIST_BASE_URL: string = URLConstants.GCNS_BASE_URL + "/whatsapp/conversations/all";
    static CHAT_MESSAGES_BASE_URL: string = URLConstants.GCNS_BASE_URL + "/conversation/messages";
    static DIRECT_MESSAGES_BASE_URL: string = URLConstants.GCNS_BASE_URL + "/whatsapp/message/direct";
    static CONVERSATION_UPDATE_BASE_URL: string = URLConstants.GCNS_BASE_URL + "/conversation/agent";
    static All_TAG_BASE_URL: string = URLConstants.GCNS_BASE_URL + "/account/tag/fetch";
    static CREATE_TAG_BASE_URL: string = URLConstants.GCNS_BASE_URL + "/account/tag/add";
    static ASSIGN_TAG_BASE_URL: string = URLConstants.GCNS_BASE_URL + "/account/conversation/tag";
    static REMOVE_TAG_BASE_URL: string = URLConstants.GCNS_BASE_URL + "/account/conversation/tag/delete";
    static CHAT_LIST_BY_TAG_BASE_URL: string = URLConstants.GCNS_BASE_URL + "/whatsapp/conversations/tags/assigned";
  ...
  static SEND_MESSAGE_BASE_URL: string = URLConstants.GSNS_BASE_URL + "/whatsapp/templates/message";
  static SEND_CAMPAIGN_BASE_URL: string = URLConstants.GABS_BASE_URL + "/whatsapp/campaign";
